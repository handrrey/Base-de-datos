<?php
    ...
    // Exportar reporte de productos agotados
    if (isset($_POST['exportar_agotados'])) {
        $query = "SELECT * FROM productos WHERE CANTIDAD_DISP = 0 ORDER BY ID_PRODUCTO ASC";
        $filename = "Productos_Agotados.csv";
...
<body>
    ...
    <div class="center-box">
        ...
        <form class="sinFondo" method="POST">
            <button type="submit" name="exportar_agotados" value="1">Exportar Productos Agotados</button>
        </form>
